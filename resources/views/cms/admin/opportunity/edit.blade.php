...
<div class="card p-4">
    ...
    <form id="create_form">
        <div class="row">
            ...
            <div class="form-group col-md-6 mb-3">
                <label>المقاعد المعبأة</label>
                <input type="number" id="filled_seats" class="form-control" value="{{ $opportunity->filled_seats }}">
            </div>
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <select id="companies_id" class="form-control">
                    @foreach($companies as $company)
                        <option value="{{ $company->id }}" {{ $opportunity->companies_id == $company->id ? 'selected' : '' }}>
                            {{ $company->name }}
                        </option>
                    @endforeach
                </select>
...
<script>
    function performUpdate() {
        ...
        let data = {
            ...
            filled_seats: document.getElementById('filled_seats').value,
        ...
        update('{{ route('admin.opportunities.update', $opportunity->id) }}', data, '{{ route('admin.opportunities.index') }}');
    }
</script>
@endsection
