    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.company.dashboard') }}" class="nav-link text-white">الرئيسية</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('company.profile') }}" class="nav-link text-white">البروفايل</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('opportunities.index') }}" class="nav-link text-white">فرص التدريب</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('opportunities.create') }}" class="nav-link text-white">انشاء فرصة</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('applications.index') }}" class="nav-link text-white">الطلبات</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.company.interns') }}" class="nav-link text-white">المتدربين</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.company.evaluation') }}" class="nav-link text-white">التقييم</a>
            </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right text-right" dir="rtl">
                   <span class="dropdown-item dropdown-header">{{ $navNotifications->count() }} إشعار</span>
...
@endforelse
    ...
    @php
        ...
        $companyImage = $company?->images->first() ?? null;
    @endphp
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            ...
            {{-- صورة الشركة --}}
            @if($companyImage)
                <img src="{{ asset('storage/' . $companyImage->path) }}"
        ...
        <div class="info">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column admin-sidebar-menu" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.dashboard*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview" style="{{ request()->routeIs('cms.company.dashboard') ? 'display:block;' : 'display:none;' }}">
                            <li class="nav-item">
                                <a href="{{ route('cms.company.dashboard') }}" class="nav-link {{ request()->routeIs('cms.ompany.dashboard') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('company.profile') }}" class="nav-link {{ request()->routeIs('cms.Company.profile') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('opportunities.create') }}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="" class="nav-link">
                  ...
                  <p>عرض</p>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.company.interns') }}" class="nav-link {{ request()->routeIs('cms.Company.interns') ? 'active' : '' }}">
...
<li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.company.evaluation') }}" class="nav-link {{ request()->routeIs('cms.Company.evaluation') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-bell"></i>
                            <p>التقييم</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('notifications') }}" class="nav-link {{ request()->routeIs('cms.Company.notifications') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-bell"></i>
                            <p>الاشعارات</p>
                        </a>
                    </li>
