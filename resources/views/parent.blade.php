...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.opportunities') }}" class="nav-link text-white">الفرص</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.internships') }}" class="nav-link text-white">التدريب</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.reports') }}" class="nav-link text-white">التقارير</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.certificates') }}" class="nav-link text-white">الشهادات</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column admin-sidebar-menu" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.supervisors.index') }}" class="nav-link {{ request()->routeIs('admin.supervisors') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.opportunities') }}" class="nav-link {{ request()->routeIs('admin.opportunities') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.internships') }}" class="nav-link {{ request()->routeIs('admin.internships') ? 'active' : '' }}">
